...
1. Download Supv0.9.2-beta.zip ( https://github.com/embiimob/Sup/releases/download/Supv0.9.2-beta/Supv0.9.2-beta.zip )
...
- this experiment uses the same kubos command line tool source as p2fk.io: https://github.com/ipfs/kubo/releases/download/v0.41.0/kubo_v0.41.0_windows-amd64.zip (packaged here as ipfs/kubos.exe)
