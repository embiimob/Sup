...
1. Download Supv0.7.8-beta.zip ( https://github.com/embiimob/Sup/releases/download/Supv0.7.8-beta/Supv0.7.8-beta.zip )
...
- this experiment uses the most recent ipfs kubo command line tool found here https://github.com/ipfs/kubo/releases/download/v0.39.0/kubo_v0.39.0_windows-amd64.zip (updated December 2025)
