...
public class Test
{
    ...
    {
        Test t = new Test();
        File.WriteAllBytes("dummy_avif.avif", new byte[] { 0, 0, 0, 0, 0x66, 0x74, 0x79, 0x70, 0x61, 0x76, 0x69, 0x66 });
        Console.WriteLine("Is AVIF unsupported? " + t.IsUnsupportedImageFormat("dummy_avif.avif"));
    }
}
